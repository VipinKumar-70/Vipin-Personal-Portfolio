          ...
          <nav className="max-w-[1370px] py-8 flex justify-between items-center">
            <div className="flex items-center">
              ...
              <a href="mailto:vipin70kr@gmail.com" ref={mailRef}>
                <span className="hidden md:inline-block text-white hover:text-[#5c34ac] duration-300 lg:text-xl text-center font-bold font-folio">
                  vipin70kr@gmail.com
                </span>
              </a>
            </div>
            ...
            <div className="lg:hidden flex items-center gap-4">
              ...
              <button className="bg-gradient-to-r from-[#7a47df] via-[#5c34ac] to-[#311960] px-[20px] py-2 text-white text-[16px] rounded-3xl font-folio">
                Hire me!
              </button>
            ...
            <div className="hidden lg:flex items-center justify-between gap-8 px-5">
              ...
              <div className="hidden lg:block" ref={hireRef}>
                <a href="mailto:vipin70kr@gmail.com">
                  <button className="relative bg-gradient-to-r from-[#956ae9] via-[#5c34ac] to-[#311960] px-[30px] py-2 text-white text-[16px] rounded-3xl font-folio font-bold transition-all duration-500 ease-in-out overflow-hidden group">
              ...
              <div className="lg:hidden absolute top-[90px] left-0 w-full bg-[#140c1c] p-8 z-10 px-5">
                <ul className="flex flex-col gap-6 items-center">
                  {["Home", "Resume", "Skills", "Projects", "Contact"].map(
                    (items, index) => (
                      <li
                        className="text-[18px] text-white font-folio"
                        key={index}
                      >
                        <Link
                          to={`${items.toLowerCase()}`}
