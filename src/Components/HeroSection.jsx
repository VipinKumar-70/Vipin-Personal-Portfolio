      ...
      <section className="w-full mx-auto lg:px-20 px-4 py-6 text-white bg-gradient-to-r from-[#0f0715] via-[#0f0715] to-[#221338]">
        <div className="max-w-[1370px] w-full py-8 flex md:justify-between justify-center gap-y-4 items-center md:px-10 lg:px-0">
          <div
            ...
            ref={heroLeftRef}
          >
            <div className="lg:text-5xl md:text-3xl text-3xl font-folio text-gray-300">
              I am Vipin
            </div>
            <div className="xl:text-7xl lg:text-6xl md:text-4xl text-3xl font-bold bg-gradient-to-r from-[#6941a5] via-[#b09bd1] to-[#cac5d1] bg-clip-text text-transparent py-2 font-folio">
            ...
            <div className="font-folio text-[18px] text-gray-300 lg:w-[70%] w-full">
